...
- **Batch geocoding**: Bulk processing with
...
[arcgisgeocode](https://github.com/r-arcgis/arcgisgeocode) is part of
the [arcgis](https://github.com/R-ArcGIS/arcgis/) metapackage, which
...
endpoints made available via the
[`find_address_candidates()`](https://developers.arcgis.com/r-bridge/api-reference/arcgisgeocode/reference/find_address_candidates.md),
[`reverse_geocode()`](https://developers.arcgis.com/r-bridge/api-reference/arcgisgeocode/reference/reverse_geocode.md),
and
[`suggest_places()`](https://developers.arcgis.com/r-bridge/api-reference/arcgisgeocode/reference/suggest_places.md)
...
is available via
[`geocode_addresses()`](https://developers.arcgis.com/r-bridge/api-reference/arcgisgeocode/reference/geocode_addresses.md).
However, this requires the use of an authorization token and may consume
credits.
...
The
[`find_address_candidates()`](https://developers.arcgis.com/r-bridge/api-reference/arcgisgeocode/reference/find_address_candidates.md)
function returns geocoding candidate results. The function is vectorized
over the input and will perform multiple requests in parallel. Each
request geocodes one location at a time.
...
[`suggest_places()`](https://developers.arcgis.com/r-bridge/api-reference/arcgisgeocode/reference/suggest_places.md)
function (`/suggest` endpoint) is intended to be used as part of a
client-facing application that provides autocomplete suggestions.
...
[`find_address_candidates()`](https://developers.arcgis.com/r-bridge/api-reference/arcgisgeocode/reference/find_address_candidates.md)
to complete the geocoding process. The column `text` contains the
address to geocode. The column `magic_key` is a special identifier that
makes it much faster to fetch results. Pass this into the argument
`magic_key`.
...
[`geocode_addresses()`](https://developers.arcgis.com/r-bridge/api-reference/arcgisgeocode/reference/geocode_addresses.md)
function which calls the `/geocodeAddresses` endpoint. Note that this
function requires an authorization token.
[`geocode_addresses()`](https://developers.arcgis.com/r-bridge/api-reference/arcgisgeocode/reference/geocode_addresses.md)
sends the input addresses in chunks as parallel requests.
...
You can use
[`list_geocoders()`](https://developers.arcgis.com/r-bridge/api-reference/arcgisgeocode/reference/list_geocoders.md)
...
[arcgisgeocode](https://github.com/r-arcgis/arcgisgeocode) can be used
with other geocoding services, including custom locators hosted on
ArcGIS Online or Enterprise. You can search for geocoding services that
may be useful for you with
